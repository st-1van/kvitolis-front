    ...
    return(
        <section className="weHave" id='festivals'>
            <OtherAttraction 
                ...
                desc='Щороку у "Квітолісі" проходить низка унікальних квіткових фестивалів, які відображають красу природи у різні пори року. Це масштабне свято квітів, яке обʼєднує людей з різних куточків України.'
